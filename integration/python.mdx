...
<Note>
  This guide uses the `requests` library for the client. For async operations,
  consider using `httpx` or `aiohttp`. FastAPI is used for the web framework
  examples.
</Note>
...
class ZeroXMetaClient:
    def __init__(self, api_key: str):
        ...
        self.base_url = 'https://facilitator.0xmeta.ai/v1'
